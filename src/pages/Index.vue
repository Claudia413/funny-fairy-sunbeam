<template>
  <Layout>
    ...
    <h1>Hi there!</h1>
    <p>
      This page has not yet received much love and attention. The other pages, which you can access through the menu above, have more information and features to look at.
    </p>
